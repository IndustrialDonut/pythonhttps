"""Functions to help generate private and public keys"""
...
def generate_private_key(filename: str, passphrase: str):
    """Generate a private key with fixed public exponent and key size,
    writes private key to disk under encryption of the provided passphrase."""

    private_key = rsa.generate_private_key(
        # Public exponent and key size are AGREED UPON "IN THE STANDARD" BY BOTH PARTIES IN ADVANCE OF ANY KEY PAIR GENERATION
